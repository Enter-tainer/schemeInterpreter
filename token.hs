module Token where
import Data.Char
data LToken = NumLit Int | VarLit String | Equal| NotEq | Greater | Less | GreaterEq | LessEq | Plus | Minus | Multi | Divide | Define | If | Cond | Lambda | Else | Let | And | Or | Not | Par [LToken] deriving (Eq, Show, Ord)
